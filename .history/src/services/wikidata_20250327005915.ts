...
export class WikidataService {
  ...
  private buildQuery(options: QueryOptions): string {
    ...
    const parentFilter = parentId 
      ...
      : `VALUES ?item { wd:Q12308942 wd:Q12308943 wd:Q12308944 wd:Q12308945 }`; // Liste des principales périodes
    
    return `
      SELECT DISTINCT ?item ?itemLabel ?startDate ?endDate
      WHERE {
        ${parentFilter}
        ?item wdt:P31 wd:Q12308942.  # Instance de période géologique
