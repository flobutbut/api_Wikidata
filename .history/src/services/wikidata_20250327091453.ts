  ...
  private transformResponse(bindings: any[]): GeologicalPeriod[] {
    return bindings.map(binding => {
      ...
      return {
        ...
        startDate: binding.startDate?.value ? this.formatDate(binding.startDate.value) : undefined,
        endDate: binding.endDate?.value ? this.formatDate(binding.endDate.value) : undefined,
